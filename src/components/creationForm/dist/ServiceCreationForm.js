...
exports.Label = exports.Comment = exports.Protocol = exports.Port = exports.Name = exports.Type = exports.CheckIcon = exports.ServiceTypeInput = exports.TrashIcon = exports.Index = exports.errorClass = exports.defaultClass = exports.PortInputs = exports.PortRangeInputs = exports.ServiceTypeInputs = exports.ServicePopupForm = void 0;
...
function PortRangeInputs(_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(exports.Port, { isFocus: isFocused(service) == INPUT_ELEMENTS.PORT, name: "Port End", inputHandler: service.portRangeInputHandler.portToHandler }),
...
exports.Port = function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement(exports.Label, { value: name }),
        React.createElement("input", { type: "text", name: "port", id: "port", autoFocus: isFocus, onChange: function (event) { return inputHandler.setInputValue(event.target.value); }, value: inputHandler.inputValue, placeholder: "80", className: inputStyle(inputHandler.isError), required: true }),
        React.createElement(If_1.If, { condition: inputHandler.isError },
            React.createElement("p", null, inputHandler.error))));
};
var inputStyle = function (isError) {
    if (isError) {
...
exports.Protocol = function (_a) {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("input", { type: "protocol", name: "protocol", id: "protocol", autoFocus: isFocus, value: inputHandler.inputValue, onChange: function (event) { return inputHandler.setInputValue(event.target.value); }, placeholder: "TCP", className: inputStyle(inputHandler.isError), required: true }),
        React.createElement(If_1.If, { condition: inputHandler.isError },
            React.createElement("p", null, inputHandler.error))));
};
