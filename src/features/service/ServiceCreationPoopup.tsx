...
import { RenderSideBarElement } from "../sidebar/SideBar";

import { selectService } from "./serviceSlice";
...
export const CheckIcon = ({ onClick }: { onClick: () => void }) => {
  return (
    <div
      onClick={onClick}
      className="hover:cursor-pointer hover:border h-10 w-10 hover:shadow-lg rounded-md"
    >
      <svg
        version="1.1"
        id="Layer_1"
